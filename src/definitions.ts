...
export interface RuntimeInfo {
  ...
  usedSD: number
  /** The amount of used CPU in percent. */
  // usedCPU?: number
}
...
export interface SoftwareInfo {
  ...
  /** The list of locales used by the device */
  locales: string[]
...
export type SystemInformation = SoftwareInfo & HardwareInfo
...
export interface SystemInfoPlugin {
   ...
   */
  getInfos: () => Promise<SystemInformation>
  /**
   ...
   */
  addListener: (eventName: 'runtimeChange', listenerFunc: (event: RuntimeInfo) => void) => Promise<PluginListenerHandle>
  /**
