import type { Features, SystemInfoPlugin, SystemInformation } from './definitions'
...
export class SystemInfoWeb extends WebPlugin implements SystemInfoPlugin {
  async getInfos() {
    ...
    const totalHDD = Number.parseInt((estimate / 1024 ** 3).toFixed(2))
